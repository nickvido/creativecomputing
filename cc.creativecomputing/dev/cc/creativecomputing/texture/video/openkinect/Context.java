...
package cc.creativecomputing.texture.video.openkinect;
...
//		System.loadLibrary("OpenKinect");
		System.out.println(new File("lib/kinect/libKinect.jnilib").getAbsolutePath());
		System.load(new File("lib/kinect/libKinect.jnilib").getAbsolutePath());
	}
