...
import cc.creativecomputing.cv.CCBox2i;
...
public class CCConnectedPixelArea {
	 ...
	 * @return maximum value inside the pixel row
	 */
	public CCVector3f max(CCPixelRaster theRaster) {
		float myMax = 0;
		int myCountMaxs = 0;
		...
		return new CCVector3f((int)(myX / myCountMaxs),(int)(myY / myCountMaxs), myMax);
	}
