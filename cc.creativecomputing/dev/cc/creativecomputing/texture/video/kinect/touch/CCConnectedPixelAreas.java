 ...
 * permission notice:  
 */
package cc.creativecomputing.texture.video.kinect.touch;
...
public class CCConnectedPixelAreas {
	 ...
	 */
	private List<CCConnectedPixelRow> scanPixelLine(final CCPixelRaster theRaster, final int theY, final float theThreshold) {
		int myRowStartX = 0;
		int myRowEndX = 0;
	 ...
	 */
	public List<CCConnectedPixelArea> connectedPixelAreas(final CCPixelRaster theRaster, float theThreshold) {
