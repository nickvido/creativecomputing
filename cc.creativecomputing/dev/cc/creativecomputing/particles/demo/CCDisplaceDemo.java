...
public class CCDisplaceDemo extends CCApp {
	...
	private CCTextureDisplace _myDisplace;
	...
	public void setup() {
		...
		_myParticles.addForce(_myDisplace = new CCTextureDisplace(CCTextureIO.newTextureData("demo/particles/heightmap.png")));
...
//		CCScreenCapture.capture("export/openclparticles01/particles_", width, height);
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCDisplaceDemo.class);
