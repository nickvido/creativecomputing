...
public class CCNoiseSphereDemo extends CCApp {
	...
	@Override
	public void setup() {
		_myShader = new CCGLSLShader("demo/gpu/noisesphere/perlin_vert.glsl", "demo/gpu/noisesphere/perlin_frag.glsl");
//		_myShader.uniform("permTexture", 0);
		...
		addControls(MaterialControl.class);
		addControls(LightControl.class);
	...
	public void update(final float theDeltaTime) {
		...
		_myMaterial.ambient(MaterialControl.ambientRed, MaterialControl.ambientGreen, MaterialControl.ambientBlue);
		_myMaterial.diffuse(MaterialControl.diffuseRed, MaterialControl.diffuseGreen, MaterialControl.diffuseBlue);
		_myMaterial.specular(MaterialControl.specularRed, MaterialControl.specularGreen, MaterialControl.specularBlue);
		_myMaterial.shininess(MaterialControl.shininess);
		
		_myPointLight.diffuse(LightControl.diffuseRed, LightControl.diffuseGreen, LightControl.diffuseBlue);
		_myPointLight.specular(LightControl.specularRed, LightControl.specularGreen, LightControl.specularBlue);
		_myPointLight.fallOff(LightControl.constantFallOff, LightControl.linearFallOff, LightControl.quadraticFallOff);
