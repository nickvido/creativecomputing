...
//		fixUpdateTime(1 / 50f);
		...
		_myHeightMap = new CCHeightMap("demo/particles/texone.png");

		List<CCGPUConstraint> myConstraints = new ArrayList<CCGPUConstraint>();
		_myTexture = new CCTexture2D(CCTextureIO.newTextureData("demo/particles/texone.png"), CCTextureTarget.TEXTURE_RECT);
...
//		myConstraints.add(_myTerrainConstraint);
	...
	public void update(final float theDeltaTime) {
		...
		CCGPUParticle myParticle1 = _myParticles.allocateParticle(myPosition, new CCVector3f(), 30);
		CCGPUParticle myParticle2 = _myParticles.allocateParticle(myPosition2, new CCVector3f(), 30);
		CCGPUParticle myParticle3 = _myParticles.allocateParticle(myPosition3, new CCVector3f(), 30);
