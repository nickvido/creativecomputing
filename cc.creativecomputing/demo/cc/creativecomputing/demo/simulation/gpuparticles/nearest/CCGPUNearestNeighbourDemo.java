...
public class CCGPUNearestNeighbourDemo extends CCApp {
	...
	private CCShaderTexture _myData;
	private CCShaderTexture _myConnectionData;
	private CCShaderTexture _myConnectionDataTmp;
	...
	@Override
	public void setup() {
		_myData = new CCShaderTexture(32,4,xRes, yRes);
		...
		_myConnectionData = new CCShaderTexture(32,4,xRes * 6, yRes);
		...
		_myConnectionDataTmp = new CCShaderTexture(32,4,xRes * 6, yRes);
	...
	public void update(final float theDeltaTime) {
		...
		CCShaderTexture myKeep = _myConnectionDataTmp;
