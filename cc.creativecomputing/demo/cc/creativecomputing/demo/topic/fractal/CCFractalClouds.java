...
public class CCFractalClouds{
	...
	public CCFractalClouds(CCGraphics g, int theWidth, int theHeight){
		...
		_myRenderTexture = new CCRenderTexture(g, _myWidth / 2, _myHeight / 2);
		...
		_myParticleTriangleMesh.texture0(_myRenderTexture);
		_myParticleTriangleMesh.texture1(_myRenderTexture);
	}
