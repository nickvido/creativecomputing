...
public class CCMosaicTriangleMesh{
	...
	private CCShaderTexture _myTargetsTexture;
	...
	public CCMosaicTriangleMesh(final CCGraphics g, final List<CCTriangle2d> theTriangles, final int theSubdivisions) {
		...
		_myTargetsTexture = new CCShaderTexture(32, 3, 3, _myDataWidth, _myDataHeight);
	...
	public void draw(CCGraphics g) {
		...
		g.texture(0, _myTargetsTexture, 0);
		g.texture(1, _myTargetsTexture, 1);
		g.texture(2, _myTargetsTexture, 2);
