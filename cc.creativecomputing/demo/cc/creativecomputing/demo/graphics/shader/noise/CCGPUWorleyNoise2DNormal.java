...
public class CCGPUWorleyNoise2DNormal extends CCApp {
	...
	private CCShaderTexture _myWorleyTexture;
	...
	public void setup() {
		...
		_myWorleyTexture = new CCShaderTexture(nWidth, nHeight, CCTextureTarget.TEXTURE_2D);
		_myWorleyTexture.textureFilter(CCTextureFilter.LINEAR);
