...
public class CCUIControlsExternalTest extends CCApp {
	...
	private static class CCControls{
		...
		@CCControl (name = "number", min = 0, max = 200, external = true)
		private static float number = 0;
	}

	@Override
	public void setup() {
		_myUI.addExternalController(new CCExternalController() {
			
			public void addControl(
				String theTabName, String theObjectID,
				CCValueControl theControl
			) {
			}
		});
		addControls(CCControls.class);
		frameRate(30);
	}
	...
	public static void main(String[] args) {
		CCApplicationManager myManager = new CCApplicationManager(CCUIControlsExternalTest.class);
