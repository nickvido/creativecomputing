package cc.creativecomputing.gpu.dev.lineantialiasing;
...
public class CCGPULineAntiAliasing{
	...
	public CCGPULineAntiAliasing(final CCApp theApp) {
		...
		_myLineShader = new CCCGShader(
			CCGPUUtil.shaderPath("lineantialiasing/lineantialiasing.vp"),
			CCGPUUtil.shaderPath("lineantialiasing/lineantialiasing.fp")
		);
