...
public class CCBufferUtil {
	 ...
	 * @param theSize size for the buffer 
	 ...
	 * @param theBuffer buffer to be filled
	 * @param theValue value for the buffer
	 */
    ...
    public static final Buffer newDirectGLBuffer(CCPixelType theType, int numElements) {
        switch (theType) {
            case UNSIGNED_BYTE:
            case BYTE:
    ...
    public static final Buffer sliceGLBuffer(ByteBuffer parent, int bytePos, int byteLen, CCPixelType theType) {
    ...
    public static ByteBuffer readAll2Buffer(InputStream stream) throws IOException {
        ...
        return Buffers.newDirectByteBuffer(bytesRead.data, 0, bytesRead.payloadLen);
    }
