 ...
 *
 */
public class CCCameraMover implements CCEventListener, CCKeyListener, CCUpdateListener, CCMouseMotionListener{
	...
	public CCCameraMover(final CCAbstractApp theApp, final CCCamera theCamera){
