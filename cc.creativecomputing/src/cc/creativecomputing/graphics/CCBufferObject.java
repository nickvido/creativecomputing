...
//		unmapBuffer(CCBufferTarget.ARRAY);
	...
	public void copyDataFromTexture(CCShaderTexture theShaderTexture, final int theID, final int theX, final int theY, final int theWidth, final int theHeight){
    	...
    	gl.glReadPixels(theX, theY, theWidth,theHeight, theShaderTexture.format().glID, GL.GL_FLOAT, 0);
