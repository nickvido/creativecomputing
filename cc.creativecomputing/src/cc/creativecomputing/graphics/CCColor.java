...
import cc.creativecomputing.newui.animation.CCBlendModifier;
import cc.creativecomputing.newui.animation.CCBlendable;
import cc.creativecomputing.newui.animation.CCProperty;
import cc.creativecomputing.newui.animation.CCPropertyObject;

/**
 * CCColour represents a color with a red a green a blue and an
...
//		}
	...
	public void set(final float theRed, final float theGreen, final float theBlue, final float theAlpha) {
	...
	public void set(final float theRed, final float theGreen, final float theBlue) {
		set(theRed, theGreen, theBlue, 1f);
	}

	public void set(final float theGray, final float theAlpha) {
		set(theGray, theGray, theGray, theAlpha);
	}

	public void set(final float theGray) {
		set(theGray, 1f);
	}
	...
	public void add(final float theRed, final float theGreen, final float theBlue){
		r += theRed;
		g += theGreen;
		b += theBlue;
	}
