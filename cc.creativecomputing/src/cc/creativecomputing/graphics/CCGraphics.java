...
public class CCGraphics{
	...
	private void applyTextureTransformation(final int theTextureUnit, final CCTexture theTexture) {
		_myTexturesInUse[theTextureUnit] = true;
	...
	private boolean[] _myTexturesInUse = new boolean[8];
	...
	private CCTextureMode _myTextureMode = CCTextureMode.TARGET_BASED;
	 ...
	 * </ul>
	 * The default mode is <code>TARGET BASED</code>. In IMAGE, if an image is 100 x 200 pixels, mapping the 
	 * image onto the entire size of a quad would require the points (0,0) (0,100) (100,200) (0,200). 
...
//			}
	...
	public void beginOrtho(final int theWidth, final int theHeight){
		...
		gl.glOrtho(0, theWidth, theHeight, 0, -1000, 1000);
	...
	public static CCColorMaterialMode OFF = CCColorMaterialMode.OFF;
	public static CCColorMaterialMode EMISSION = CCColorMaterialMode.EMISSION;
	public static CCColorMaterialMode AMBIENT = CCColorMaterialMode.AMBIENT;
	public static CCColorMaterialMode DIFFUSE = CCColorMaterialMode.DIFFUSE;
	public static CCColorMaterialMode AMBIENT_AND_DIFFUSE = CCColorMaterialMode.AMBIENT_AND_DIFFUSE;
	public static CCColorMaterialMode SPECULAR = CCColorMaterialMode.SPECULAR;
	...
	public static final CCShapeMode CENTER = CCShapeMode.CENTER; // former
																				// CENTER_DIAMETER
	private CCShapeMode _myImageMode = CORNER;

	private CCShapeMode _myRectMode = CORNER;
	
	private CCShapeMode _myEllipseMode = CENTER;
