...
import cc.creativecomputing.graphics.texture.format.CCJaiImageFormat;
...
public class CCTextureIO {
	...
	public static List<CCTextureData> newTextureDatas(final String theFolder){
		...
		return newTextureDatas(listTextures(theFolder));
	}
	...
	public static CCTextureFormat TIFF_FORMAT = new CCJaiImageFormat();
	...
	static {
		...
		addTextureFormat("tiff", TIFF_FORMAT);
		addTextureFormat("tif", TIFF_FORMAT);
	}
