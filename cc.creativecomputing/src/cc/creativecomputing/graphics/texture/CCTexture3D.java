...
public class CCTexture3D extends CCTexture{
	...
	public CCTexture3D(final CCTextureTarget theTarget, CCTextureAttributes theAttributes, int theNumberOfTextures, final int theWidth, final int theHeight, final int theDepth){
