...
public enum CCPixelInternalFormat{
	...
	RGB16F(GL2.GL_RGB16F,3,0, 1, 2,-1),
	...
	private CCPixelInternalFormat(final int theGLid, final int theNumberOfBytes, final int theOffset1, final int theOffset2, final int theOffset3, final int theOffset4){
		glID = theGLid;
		numberOfBytes = theNumberOfBytes;
		offset1 = theOffset1;
		offset2 = theOffset2;
		offset3 = theOffset3;
		offset4 = theOffset4;
