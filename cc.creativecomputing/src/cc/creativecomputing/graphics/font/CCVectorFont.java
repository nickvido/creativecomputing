...
public class CCVectorFont extends CCFont<CCVectorChar> {
	...
	public CCVectorFont(
		...
		final boolean theIsAntialias, final int theDetail
	){
	...
	public CCVectorFont(final Font theFont, final CCKerningTable theKerningTable, final CCCharSet theCharSet, final boolean theIsAntialias) {
		this(theFont, theKerningTable, theCharSet, theIsAntialias, 30);
	}
