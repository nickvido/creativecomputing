...
public class CC3DFont extends CCFont<CC3DChar> {
	...
	public CC3DFont(
		final Font theFont, final CCKerningTable theKerningTable, final CCCharSet theCharSet, 
		final boolean theIsAntialias, final int theDetail, final float theDepth
	){
		super(theFont, theKerningTable, theCharSet, theIsAntialias);

		_myBezierDetail = theDetail;
		_myDepth = theDepth;
	}
	
	public CC3DFont(final Font theFont, final CCKerningTable theKerningTable, final CCCharSet theCharSet, final boolean theIsAntialias, final float theDepth) {
		this(theFont, theKerningTable, theCharSet, theIsAntialias, 30, theDepth);
	}
