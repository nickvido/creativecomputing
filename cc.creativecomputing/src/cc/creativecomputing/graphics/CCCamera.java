 ...
 */
public class CCCamera implements CCDrawListener{
	// --- Class Attributes ----
...
//		);
	...
	private final double[] proj = new double[16];
	private final double[] model = new double[16];
	...
	public void updateProjectionInfos(){
		...
		_myGraphics.gl.glGetDoublev(GLMatrixFunc.GL_PROJECTION_MATRIX, proj, 0);

		// get modelview matrix
		_myGraphics.gl.glGetDoublev(GLMatrixFunc.GL_MODELVIEW_MATRIX, model, 0);
	}
