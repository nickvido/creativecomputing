...
public class CCDeferredShading extends CCPostProcessEffect{
	...
	private CCRenderTexture	_myTexture;
	...
	public void initialize(int theWidth, int theHeight) {
		_myTexture = new CCRenderTexture(_myGraphics, theWidth, theHeight);
		_myWidth = theWidth;
		_myHeight = theHeight;
	}
