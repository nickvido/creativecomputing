...
public class CCGPUConvolutionShader extends CCCGShader{
	...
	public CCGPUConvolutionShader(final CCGraphics theGraphics) {
		super(null,CCGPUUtil.shaderPath("imaging/convolution.fp"));
	}
	...
	public CCGPUConvolutionShader(final CCGraphics theGraphics, final int theKernelWidth, final int theKernelHeight) {
		super(null,CCGPUUtil.shaderPath("imaging/convolution.fp"));
	...
	public CCGPUConvolutionShader(final CCGraphics theGraphics, final List<Float> theKernel, final int theKernelWidth, final int theKernelHeight) {
		this(theGraphics,theKernelWidth, theKernelHeight);
