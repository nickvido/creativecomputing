...
public class CCTimedDataUI extends CCUIValueElement<CCTimedData[]> implements CCZoomable{
	...
	public static final CCColor FILL_COLOR = CCColor.parseFromInteger(0xff006799);
	public static final CCColor DOT_COLOR = CCColor.parseFromInteger(0xff007FBF);
	...
	private void drawCurvePiece(CCGraphics g, CCTimedData theData,CCVector2f myFirstPoint, CCVector2f mySecondPoint) {
		...
		if (myFirstPoint == null) {
			myFirstPoint = new CCTimedDataPoint(_myLowerBound, mySecondPoint.y);
		} else if (mySecondPoint == null) {
