 ...
 *
 */
@CCPropertyObject(name = "spacing")
public class CCUISpacing {

	@CCProperty(name = "left", node = false, optional = true)
	private float _myLeft;

	@CCProperty(name = "right", node = false, optional = true)
	private float _myRight;

	@CCProperty(name = "top", node = false, optional = true)
	private float _myTop;

	@CCProperty(name = "bottom", node = false, optional = true)
