 ...
 */
public class CCMidiEvent extends ShortMessage{
	 ...
	 * @see #message
	 */
	private CCMidiEvent(byte[] theData){
		super(theData);
	}
	...
	CCMidiEvent(final MidiMessage theMidiMessage){
	 ...
	 */
	CCMidiEvent(int theCommand, int theNumber, int theValue){
		this();
		try{
	...
	CCMidiEvent(final CCMidiStatus theStatus){
		super(null);
	...
	public Object clone(){
		...
		CCMidiEvent msg = new CCMidiEvent(newData);
		return msg;
	}
}
