...
public class CCMidiIO{
		...
		for (int i = 0; i < infos.length; i++){
			try{
				...
				if (theDevice instanceof javax.sound.midi.Sequencer) {
					...
					_myMidiInputDevices.add(new CCMidiInDevice(this, theDevice, i));
				}
	...
	public CCMidiOut midiOut(final int theMidiChannel, final int theOutDeviceNumber){
		...
		try{
			...
			e.printStackTrace();
			throw new RuntimeException("You wanted to open the unavailable output " + theOutDeviceNumber + ". The available outputs are 0 - " + (numberOfOutputDevices() - 1) + ".");
		}
	}
	...
	public CCMidiOut midiOut(final int theMidiChannel, final String theOutDeviceName){
		...
		throw new UnavailablePortException("There is no output with the name " + theOutDeviceName + ".");
	}
	...
	public void closeInput(int theInputNumber){
		try{
			...
			throw new UnavailablePortException("You wanted to close the unavailable input " + theInputNumber + ". The available inputs are 0 - " + (_myMidiInputDevices.size() - 1) + ".");
		}
	...
	public void closeInput(String theInputName){
		...
		throw new UnavailablePortException("There is no input with the name " + theInputName + ".");
	}
	...
	public void closeOutput(String theOutputName){
		...
		throw new UnavailablePortException("There is no output with the name " + theOutputName + ".");
	}
