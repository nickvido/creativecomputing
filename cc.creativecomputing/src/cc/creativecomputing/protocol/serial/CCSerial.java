...
public class CCSerial implements SerialPortEventListener, CCDisposeListener {
	...
	private static int DEFAULT_RATE = 9600;
	...
	public CCSerial(CCAbstractApp theAbstractApp, CCISerialListener theListener) {
		this(theAbstractApp, theListener, DEFAULT_NAME, DEFAULT_RATE, DEFAULT_PARITY, DEFAULT_DATABIT, DEFAULT_STOPBIT);
	}

	public CCSerial(CCAbstractApp theAbstractApp, CCISerialListener theListener, int theRate) {
		this(theAbstractApp, theListener, DEFAULT_NAME, theRate, DEFAULT_PARITY, DEFAULT_DATABIT, DEFAULT_STOPBIT);
	}

	public CCSerial(CCAbstractApp theAbstractApp, CCISerialListener theListener, String theName, int theRate) {
		this(theAbstractApp, theListener, theName, theRate, DEFAULT_PARITY, DEFAULT_DATABIT, DEFAULT_STOPBIT);
	}

	public CCSerial(CCAbstractApp theAbstractApp, CCISerialListener theListener, String theName) {
	 ...
	 */
	public CCSerial(
		CCAbstractApp theAbstractApp, CCISerialListener theListener, 
