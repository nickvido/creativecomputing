...
public abstract class CCOSCAtom<Type> {
	...
	public abstract Type decodeAtom(byte typeTag, ByteBuffer b) throws IOException;

	public abstract void encodeAtom(Type theObject, ByteBuffer tb, ByteBuffer db) throws IOException;
