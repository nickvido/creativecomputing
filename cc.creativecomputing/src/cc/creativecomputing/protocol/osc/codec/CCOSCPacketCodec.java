...
import cc.creativecomputing.protocol.osc.CCOSCPacket;
...
public class CCOSCPacketCodec {
	 ...
	 */
	public CCOSCPacket decode(ByteBuffer b) throws IOException {
	 ...
	 */
	public void encode(CCOSCPacket p, ByteBuffer b) throws IOException {
	...
	protected CCOSCBundle decodeBundle(ByteBuffer b) throws IOException {
	 ...
	 * @throws IllegalArgumentException occurs in some cases of buffer underflow
	 */
	public CCOSCMessage decodeMessage(String command, ByteBuffer b) throws IOException {
		final Object[] args;
		final int numArgs;
		final ByteBuffer b2;
		final int pos1;
	...
	protected void encodeBundle(CCOSCBundle bndl, ByteBuffer b) throws IOException {
		int pos1, pos2;
	 ...
	 */
	protected void encodeMessage(CCOSCMessage msg, ByteBuffer b) throws BufferOverflowException, IOException {
	...
	private class PacketAtom extends CCOSCAtom<CCOSCPacket> {
		...
		public CCOSCPacket decodeAtom(byte typeTag, ByteBuffer b) throws IOException {
			throw new IOException("Not supported");
		}

		public void encodeAtom(CCOSCPacket o, ByteBuffer tb, ByteBuffer db) throws IOException {
			tb.put((byte) 0x62); // 'b'
