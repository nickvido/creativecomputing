...
public class CCAABB {
	 ...
	 */
	public CCVector3f intersectsRay(final CCRay theRay, final float theMinDist, final float theMaxDist) {
	...
	public boolean intersectsSphere(final CCSphere theSphere) {
