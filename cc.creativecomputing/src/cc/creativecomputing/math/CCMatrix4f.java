...
public class CCMatrix4f {
	...
	public void setGL(final float[] theGLMatrix){
	...
	public void rotateX(final float s, final float c) {
		apply(
			1, 0, 0, 0, 
			0, c, -s, 0, 
			0, s, c, 0, 
	...
	public void rotateY(final float s, final float c) {
		apply(
			c, 0, s, 0, 
			0, 1, 0, 0, 
			-s, 0, c, 0, 
	...
	public void rotate(final float theAngle, final float v0, final float v1, final float v2) {
	...
	public void lookAt (CCVector3f theEye, CCVector3f theCenter, CCVector3f theUp) {
	...
	public void apply(CCMatrix4f rhs) {
		apply(
	...
	public void inverseTransform(final CCVector3f theInput, final CCVector3f theOutput) {
		float tmpx = m00 * theInput.x + m10 * theInput.y + m20 * theInput.z;
		float tmpy = m01 * theInput.x + m11 * theInput.y + m21 * theInput.z;
		float tmpz = m02 * theInput.x + m12 * theInput.y + m22 * theInput.z;
		theOutput.set(tmpx, tmpy, tmpz);
	}

	public void inverseTransform(final CCVector3f theVector) {
	...
	private final float sin(float theAngle) {
		return (float) Math.sin(theAngle);
	}

	private final float cos(float theAngle) {
	...
	public void setPosition(CCVector3f thePosition) {
		m03 = thePosition.x;
		m13 = thePosition.y;
		m23 = thePosition.z;
	}
	...
	public static CCMatrix4f makePerspective(float theFov, float theAspect, float theNear, float theFar) {
	...
	public static CCMatrix4f makeOrtho(
		float theLeft, float theRight, 
