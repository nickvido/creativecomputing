...
public class CCSphere{
    ...
    public CCSphere(final CCSphere theSphere) {
        this(theSphere._myCenter, theSphere._myRadius);
    }

    public CCSphere(final CCVector3f theCenter, final float theRadius) {
     ...
     */
    public float[] intersectRay(final CCRay theRay) {
        float[] result = null;
