...
public class CCArcball implements CCMouseListener, CCMouseMotionListener, CCEventListener, CCDrawListener, CCSizeListener {
	...
	private CCAbstractApp _myApp = null;
	...
	public CCArcball(final CCAbstractApp theApp){
		this(theApp.width, theApp.height);
		
		_myApp = theApp; 
		theApp.addEventListener(this);
	...
	public void addAsListenerTo(CCAbstractApp theApp) {
...
//		g.rotate(_myZrotation, _myRotationVector);
	...
	/* (non-Javadoc)
	 * @see cc.creativecomputing.events.CCSizeListener#size(int, int)
	 */
	@Override
