...
import cc.creativecomputing.math.CCSphere;
...
public class CCOctree<ElementType extends CCIOctreeElement> {
	 ...
	 */
	public ArrayList<ElementType> elementsWithinSphere(final CCSphere theSphere) {
	...
	public ArrayList<ElementType> elementsWithinSphere(final CCVector3f theSphereOrigin, final float theClipRadius) {
		return elementsWithinSphere(new CCSphere(theSphereOrigin, theClipRadius));
	}
